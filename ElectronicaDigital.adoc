...
A diferencia de los sistemas combinacionales, en los *sistemas secuenciales* los valores de las salidas, en un momento dado, no dependen exclusivamente de los valores de las entradas en dicho momento, sino que también dependen del estado anterior o estado interno.
