...
Cuando se activa una de sus entradas aparece a la salida el código binario correspondiente a la entrada 
que se ha activado. Están compuestos por 2^n^ entradas y "n" salidas.
